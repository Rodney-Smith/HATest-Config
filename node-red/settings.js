...
// It is possible to configure more than one store so that some values are saved
// to the local file-system and some are only held in memory.
// For example, to configure the default store to be in-memory only, and a
// second store for the file-system, the following options can be used:
// contextStorage: {
//   default: "memoryOnly",
